    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-fixed">
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <label class="control-label col-md-3" style="padding: 0px;">Filtro</label>
                                            <div class="col-md-3"><?=print_select_static(array("1"=>"Solo Attivi", "0" => "Solo Da Attivare", "A" => "TUTTI"), "filtroAttivi", $_GET['filtroAttivi']); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('#filtroAttivi').on('change', function(ev, picker) {
